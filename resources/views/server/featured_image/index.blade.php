                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item active">Featured Images
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('featured-images.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @if ($banners)
                                                @foreach ($banners as $banner)
                                                    <tr>
                                                        <td class="text-bold-600" ><img src="{{ asset('frontend/images/featured_images/'.$banner->image) }}" alt="" height="150px"></td>
                                                        {{-- <td>{{ $banner->first_text }}</td>
                                                        <td>{{ $banner->second_text }}</td> --}}
                                                        <td>
                                                            @if($banner->status == 'Active')
                                                                <a class="updateFeaturedImageStatus" id="banner-{{ $banner->id }}"
                                                                    banner_id = "{{ $banner->id }}"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('featured-images.edit',$banner->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function (){
            $(document).on("click", ".updateFeaturedImageStatus", function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "{{ route('updateFeaturedImageStatus') }}",
