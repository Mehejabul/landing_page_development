        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    @endif
                    <h5 class="content-header-title float-left pr-1 mb-0">Content Details</h5>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('content-details.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                                       ...
                                                       <td>{{ $content->content }}</td>
                                                        ...
                                                        <td>
                                                            @if($content->status == 'Active')
                                                                <a class="updateContentDetailsStatus" id="banner-{{ $content->id }}"
                                                        ...
                                                        {{-- <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('content.edit',$content->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <a class="dropdown-item" href="{{ route('content-details.index',$content->id) }}"><i class="mr-1"></i> details</a>
...
@section('js')
    ...
    {{-- <script>
        ...
        $(document).ready(function (){
            $(document).on("click", ".updateContentDetailsStatus", function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "{{ route('updateContentDetailsStatus') }}",
