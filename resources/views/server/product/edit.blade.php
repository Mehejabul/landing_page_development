                                    ...
                                    <div class="col-md-10">
                                        <fieldset >
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="e.g:Boxer" aria-describedby="basic-Createon1" value="{{ $product->name }}" name="title" required>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="150" aria-describedby="basic-Createon1" value="{{ $product->price }}" name="price" required>
                                            </div>
                                        </fieldset>
                                        {{-- <fieldset class="mt-2">
                                       ...
                                       {{-- <fieldset class="mt-2">
                                        ...
                                        <img src="{{ asset('frontend/images/'.$product->image) }}" id="output" alt="logo" width="150px" height="150px" class="mt-2 mx-1">
                                        @endif
